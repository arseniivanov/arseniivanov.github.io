...
Last year in November NVIDIA started their large GPU Programming competition on the GPUMODE server. The vibe of the competition was quickly understood to be common problems (GEMV, GEMM), but with small workload shapes/small batches, and with NVFP4 + NVFP8 numerical formats.
